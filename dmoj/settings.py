...
VNOJ_PROBLEM_DELETION_GRACE_PERIOD = datetime.timedelta(days=7)  # Grace period before a soft-deleted problem is permanently removed
VNOJ_PROBLEM_GARBAGE_COLLECTOR_TIME_LIMIT = datetime.timedelta(hours=1)  # Maximum time the garbage collection task is allowed to run per invocation
