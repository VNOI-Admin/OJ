...
from judge.admin.interface import BlogPostAdmin, FlatPageAdmin, LicenseAdmin, LogEntryAdmin, NavigationBarAdmin, BlogPostTagAdmin
...
from judge.models import Badge, BlogPost, Comment, CommentLock, Contest, ContestParticipation, \
    ...
    TagGroup, TagProblem, Ticket, BlogPostTag
