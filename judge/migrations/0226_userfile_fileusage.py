    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage_scope', models.CharField(choices=[('problem', 'Problem editor'), ('contest', 'Contest editor'), ('martor', 'Martor editor')], db_index=True, default='martor', max_length=20, verbose_name='storage scope')),
