# Generated by Django 5.2.15 on 2026-06-19 07:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='blogvote',
            constraint=models.UniqueConstraint(fields=('voter', 'blog'), name='judge_blogvote_voter_blog_uniq'),
        ),
        migrations.AddConstraint(
            model_name='commentvote',
            constraint=models.UniqueConstraint(fields=('voter', 'comment'), name='judge_commentvote_voter_comment_uniq'),
        ),
        migrations.AddConstraint(
            model_name='contestmoss',
            constraint=models.UniqueConstraint(fields=('contest', 'problem', 'language'), name='judge_contestmoss_contest_problem_language_uniq'),
        ),
        migrations.AddConstraint(
            model_name='contestparticipation',
            constraint=models.UniqueConstraint(fields=('contest', 'user', 'virtual'), name='judge_contestparticipation_contest_user_virtual_uniq'),
        ),
        migrations.AddConstraint(
            model_name='contestproblem',
            constraint=models.UniqueConstraint(fields=('problem', 'contest'), name='judge_contestproblem_problem_contest_uniq'),
        ),
        migrations.AddConstraint(
            model_name='languagelimit',
            constraint=models.UniqueConstraint(fields=('problem', 'language'), name='judge_languagelimit_problem_language_uniq'),
        ),
        migrations.AddConstraint(
            model_name='organizationmonthlyusage',
            constraint=models.UniqueConstraint(fields=('organization', 'time'), name='judge_orgmonthlyusage_org_time_uniq'),
        ),
        migrations.AddConstraint(
            model_name='problemtranslation',
            constraint=models.UniqueConstraint(fields=('problem', 'language'), name='judge_problemtranslation_problem_language_uniq'),
        ),
        migrations.AddConstraint(
            model_name='rating',
            constraint=models.UniqueConstraint(fields=('user', 'contest'), name='judge_rating_user_contest_uniq'),
        ),
        migrations.AddConstraint(
            model_name='submissiontestcase',
            constraint=models.UniqueConstraint(fields=('submission', 'case'), name='judge_submissiontestcase_submission_case_uniq'),
        ),
        migrations.AddConstraint(
            model_name='tagdata',
            constraint=models.UniqueConstraint(fields=('tag', 'problem'), name='judge_tagdata_tag_problem_uniq'),
        ),
    ]
