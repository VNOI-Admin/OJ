...
class Badge(models.Model):
    ...
    mini = models.CharField(max_length=255, verbose_name=_('mini badge URL'), blank=True)
    full_size = models.CharField(max_length=255, verbose_name=_('full size badge URL'), blank=True)
